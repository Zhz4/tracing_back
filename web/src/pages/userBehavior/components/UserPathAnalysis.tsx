...
import { ArrowRight, Home, Settings, BarChart3, Users } from "lucide-react";
...
const UserPathAnalysis = () => {
  ...
  const pageStats = [
    { page: '首页', visits: 108, bounceRate: '12%', avgTime: '2m 15s' },
    { page: '数据分析', visits: 66, bounceRate: '25%', avgTime: '4m 32s' },
    { page: '用户管理', visits: 63, bounceRate: '18%', avgTime: '3m 45s' },
    { page: '设置', visits: 35, bounceRate: '35%', avgTime: '1m 58s' }
  ];
              ...
              <div key={pathData.id} className="border rounded-lg p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex gap-4 text-sm">
                    <span>频次: <strong>{pathData.frequency}</strong></span>
                    <span>转化率: <strong>{pathData.conversionRate}</strong></span>
                  </div>
                </div>
        ...
        <CardContent>
              ...
              <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                ...
                <div className="flex gap-4 text-sm">
                  <div className="text-center">
                    <div className="font-semibold text-blue-600">{stat.visits}</div>
                    <div className="text-muted-foreground">访问量</div>
                  </div>
                  <div className="text-center">
                    <div className="font-semibold text-orange-600">{stat.bounceRate}</div>
                    <div className="text-muted-foreground">跳出率</div>
                  </div>
                  <div className="text-center">
                    <div className="font-semibold text-green-600">{stat.avgTime}</div>
          ...
          <div className="mt-4 pt-4 border-t">
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <div className="text-2xl font-bold text-primary">272</div>
                <div className="text-sm text-muted-foreground">总访问量</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-orange-600">22%</div>
                <div className="text-sm text-muted-foreground">平均跳出率</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-green-600">3m 8s</div>
